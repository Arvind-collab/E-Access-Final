...
<?php
	...
	if(empty($coord_sem[1])===true)
		header('Location:sem_teach_details.php?sem='.$coord_sem[0].'&branch='.$coord_branch[0]);
...
?>
	<div class="content">
		...
		<div class="container-type-2">
			<header>Select semester/branch to set teacher for...</header>
			<div class="columns-type-3">
				<?php
					if(empty($_POST)===false && empty($errors)===true)
					{	header('Location:../pages/sem_teach_details.php?sem='.$_POST['sem'].'&branch='.$_POST['branch']);
						}
