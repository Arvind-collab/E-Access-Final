	...
	<div class="content">
		...
		<div class="container-type-2">
			...
			<div class="columns-type-2">
				...
				<?php
					if($batch!=='')
						$url='../pages/final_workshop_result.php?batch='.$batch.'&sem='.$sem.'&branch='.$branch.'&exam='.$exam.'&subject='.$subject;
					else
						$url='../pages/final_workshop_result.php?sem='.$sem.'&branch='.$branch.'&exam='.$exam.'&subject='.$subject;
				?>
				<div class="buts">
